...
#Set aliases
echo "
alias ubuntu='proot-distro login ubuntu --user $username --shared-tmp -- env DISPLAY=:1.0 '
alias kali='proot-distro login BackTrack --user $username --shared-tmp -- env DISPLAY=:1.0 '
